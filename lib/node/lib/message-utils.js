...
class MessageUtils {
  ...
  constructor() {
    this.MESSAGE_TYPE = ['execute', 'async-conditional']
  }
  ...
  /**
   * @method createAsyncConditional
   * @description create an async-conditional message
   * 
   * @param {Object} opts
   * @param {Object} opts.tree 
   * @param {String} opts.tree.id current graph tree id
   ...
   * @param {Object} config
   */
  createAsyncConditional(opts, config={}) {
  ...
  createResponse(msg={}, opts={}) {
    ...
    } else if( msg.type === 'async-conditional' ) {
